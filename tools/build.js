...
(async () => {
  ...
  const INLINE_MEDIA = {
    post139: {
      ...
      side: 'right', after: 4,
      supportImage: 'assets/images/post139-support.jpg',
      supportCaption: 'The request can begin outside Atlassian, while a person still reviews the shared work record. Photo: SanDisk via Unsplash.'
    },
    post138: {
    ...
    post137: {
      ...
      side: 'right', after: 4,
      supportImage: 'assets/images/post137-support.jpg',
      supportCaption: 'Primary power turns a data-center build into a long-running maintenance and parts relationship. Photo: Dave Meckler via Unsplash.'
    },
    post136: {
    ...
    post135: {
      ...
      side: 'right', after: 5,
      supportImage: 'assets/images/post135-support.jpg',
      supportCaption: 'Human review has to change or reject the substance, not just clean the final export.'
    },
    post134: {
    ...
    post133: {
      ...
      side: 'right', after: 4,
      supportImage: 'assets/images/post133-support.jpg',
      supportCaption: 'Government AI adds procurement, security, sovereignty, and auditability to the same platform.'
    },
    post132: {
    ...
    post127: {
      ...
      side: 'right', after: 3,
      supportImage: 'assets/images/post127-support.jpg',
      supportCaption: 'A dinner plan is simple until the calendar, restaurant, and people all have to agree.'
    },
    post126: {
    ...
    post124: {
      ...
      side: 'left', after: 3,
      supportImage: 'assets/images/post124-support.jpg',
      supportCaption: 'The migration has to fit the systems and people already building aircraft.'
    },
    post123: {
    ...
    post122: {
      ...
      side: 'right', after: 2,
      supportImage: 'https://upload.wikimedia.org/wikipedia/commons/1/14/Family_Airport_Travel.jpg',
      supportCaption: 'The trip keeps moving only if the next handoff holds.',
    },
    post121: {
    ...
    post104: {
      ...
      side: 'right', after: 3,
      supportImage: 'https://upload.wikimedia.org/wikipedia/commons/2/20/Wafer_at_Intel_Museum.JPG',
      supportCaption: 'The custom-chip story only matters if the production path stays real.'
    },
    post103: {
    ...
    post100: {
      ...
      side: 'right', after: 3,
      supportImage: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/Wikimedia_foundation_office_presentation.jpg',
      supportCaption: 'The control question still lands in a real room with real people.'
    },
    post99: {
